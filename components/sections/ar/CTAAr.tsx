      ...
      <div className="container-wide">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            >
              سواء كنت تحتاج إلى برمجيات مخصصة أو بنية تحتية للشبكات أو تكامل مؤسسي، فريقنا جاهز لتحويل رؤيتك إلى واقع.
            </p>
